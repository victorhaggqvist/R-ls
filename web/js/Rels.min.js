...
/***/ function(module, exports, __webpack_require__) {
	...
	var requestTripCords = function requestTripCords(refs) {
	...
	var renderMap = function renderMap(mapId, geoRefs) {
	    ...
	    try {
	        ...
	        var allPoints = [];
	        requestTripCords(geoRefs).then(function (cords) {
	            cords.forEach(function (cordList) {
	                var startPoint;
	                var endPoint;
	                var pointList = cordList.map(function (p, index, src) {
	                    if (index === 0) {
