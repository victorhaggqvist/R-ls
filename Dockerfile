...
RUN apt-get install -y openssh-server vim unzip git nginx mysql-server php5 php5-fpm php5-cli php5-curl php5-mysql php5-xdebug wget curl make php-apc nodejs npm
